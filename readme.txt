=== Onsched ===
Contributors: racecorp5
Donate link: http://onsched.com
...
Installing "Onsched" can be done either by searching for "Onsched" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
